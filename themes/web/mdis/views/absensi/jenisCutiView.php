		...
		<div class="clear"></div>
            ...
            <tbody>
                ...
                <tr class=<?php echo $class?>>
                    ...
                    <td>
                        <?php echo isAccess('absensi','jenisCuti','edit') ? anchor('absensi/jenisCuti/edit/id/' . $row['id_pengalaman'],'<span class="icon_text edit"></span>Edit', 'class="button white"', 'class="button white"') : ''?>
                        
                        <?php echo isAccess('absensi','jenisCuti','delete') ? anchor('absensi/jenisCuti/view/page/'.$uri_to_assoc['page'].'/action/delete/id/' . $row['id_pengalaman'],'<span class="icon_text cancel"></span>Hapus', array('onClick' => "return confirm('".$this->lang->line('global_confirm_delete')."')" , 'class' => "button white")) : ''?>
                    </td>
                </tr> 
                <?php endforeach;?>
            </tbody>
