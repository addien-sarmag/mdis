...
//	$pdf->borderActive = $borderActive;
	...
	$thead  = array( '  No.   ','                Nama Barang Kena Pajak / Jasa Kena Pajak                                                         ','              Harga Jual / Pengganti /  Uanng Muka / Termin ( Rp. )  ');
	...
	$col[] = array('text' =>  'Test' , 'width' => $w[$n++], 'align' => 'L');
	$col[] = array('text' => 'Test' , 'width' => $w[$n++], 'align' => 'R');
	...
	$col[] = array('text' => 'Test', 'width' => $z[$n++], 'align' => 'C','linewidth'=>0.2,'linearea'=>'LTBR');
	$col[] = array('text' =>  'Test', 'width' => $z[$n++], 'align' => 'L');
	$col[] = array('text' => 'Test' , 'width' => $z[$n++], 'align' => 'R');
