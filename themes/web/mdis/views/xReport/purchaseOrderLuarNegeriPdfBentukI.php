<?php
	...
	$filename = 'Purchase-Order-Luar-Negeri'.'.pdf';
	...
	$col = array();
		$col[] = array('text' => 'Date  : '.eng_date( $dataProfile['tglPO'] ) ,'font_style' => '','height'=>5, 'width' => 70 , 'align' => 'L','linewidth'=>0.2, 'linearea'=>'LR');
		$col[] = array('text' =>  ucwords( $dataProfile['suplierAlamat'] ),'height'=>5, 'width' => 120 , 'align' => 'L','linewidth'=>0.2, 'linearea'=>'LR');
	$columns[] = $col;
	
	if ($dataProfile['paymentPO'] === 'Kredit'){
		$dataProfile['paymentPO'] = 'Credit';
	}
	$col = array();
	...
	$col = array();
		$col[] = array('text' => 'Required Delivery  : '. eng_date( $dataProfile['requiredPO'] ),'font_style' => '' ,'height'=>5, 'width' => 70 , 'align' => 'L','linewidth'=>0.2, 'linearea'=>'LR');
	...
	*/
	...
	$col[] = array('text' => $urut++ . '.','height'=>7,'font_style' => '', 'width' => $w[$n++], 'align' => 'C','linewidth'=>0.2, 'linearea'=>'LR');
	$col[] = array('text' =>  $res['desk'] , 'width' => $w[$n++], 'align' => 'L');
	$col[] = array('text' => number_format(  $res['qty'] )  , 'width' => $w[$n++], 'align' => 'R');
	$col[] = array('text' => number_format($res['unit'],2, '.',','), 'width' => $w[$n++], 'align' => 'R');
	$col[] = array('text' => number_format($res['total'],2,'.',','), 'width' => $w[$n++], 'align' => 'R');
	...
	$col[] = array('text' => '', 'width' => $w[$n++], 'align' => 'R');
	$col[] = array('text' => '' , 'width' => $w[$n++], 'align' => 'R');
	$col[] = array('text' => number_format($dataProfile['freight'],2,'.',','), 'width' => $w[$n++], 'align' => 'R');
	$columns[] = $col;
	...
	$col[] = array('text' => number_format($hargaTotal  + $dataProfile['freight'],2,'.',','), 'width' => $w[4],'font_style' => '', 'align' => 'R');
	$columns[] = $col;
