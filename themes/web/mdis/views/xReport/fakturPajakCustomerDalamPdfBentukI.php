<?php
	...
	$pdf->Cell($w[2] , 5,'Rp. '.number_format($res['fakturPajakCustomerTotal'],2,',','.'),1,1,'R');
	
	$pdf->Cell($w[0] + $w[1] , 5,'Dikurangi Potongan Harga ',1,0);
	$pdf->Cell($w[2] , 5,'Rp. '.number_format($res['fakturPajakCustomerDiskon'],2,',','.'),1,1,'R');
	
	$pdf->Cell($w[0] + $w[1] , 5,'Dikurangi Uang Muka Yang Telah Diterima',1,0);
	$pdf->Cell($w[2] , 5,'Rp. '.number_format($res['fakturPajakCustomerUangMuka'],2 , ',','.'),1,1,'R');
	
	$pdf->Cell($w[0] + $w[1] , 5,'Dasar Pengenaan Pajak',1,0);
	$pdf->Cell($w[2] , 5,'Rp. '.number_format($res['fakturPajakCustomerDasarPengenaanPajak'],2 , ',','.'),1,1,'R');
	
	$pdf->Cell($w[0] + $w[1] , 5,'PPN = 10 % x Dasar Pengenaan Pajak ',1,0);
	$pdf->Cell($w[2] , 5,'Rp. '.number_format($res['fakturPajakCustomerPpn'],2 , ',','.'),1,1,'R');
