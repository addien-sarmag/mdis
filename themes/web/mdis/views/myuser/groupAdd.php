...
<div class="column full">
		...
		<div class="clear"></div>
			...
			<?php echo form_open('myuser/group/add/time/' . time(),array('name'=>'groupAdd','id'=>'groupAdd','method'=>'post','class'=>'frModalLoad')); ?>
			...
			<div class="width90 fr">
			 <?php echo form_input(array('name'=>'desc','id'=>'desc','value'=>get_data($_POST,'desc'), 'class'=> 'form-field half small', 'size' => '20' )); ?>
			 </div>
