...
<div class="column full">
		...
		<div class="box">
		<div class="box-header">Tambah Pelamar</div>
        ...
        <br /><br />      
            ...
            <?php  echo form_open('pegawai/pelamar/add/time/' . time(),array('name'=>'formAddpelamar','id'=>'formAddpelamar'),array('kirim'=>'kirim')); ?>
            <table> 
            	<tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <?php echo form_input(array('name'=>'placeBorn','value'=>get_data($_POST,'placeBorn'),'class'=>'form-field'));?>
                         <?php echo form_input(array('name'=>'dateBorn','id'=>'dateBorn','value'=>get_data($_POST,'dateBorn'),'class'=>'form-field','style'=>"width: 100px;"));?>
                    </td>
                </tr>  
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo form_input(array('name'=>'tglReg','id'=>'tglReg','value'=>get_data($_POST,'tglReg'),'class'=>'form-field','style'=>"width: 100px;"));?>
                    </td>
                </tr> 
                <tr>
                    <td width="200">Keahlian</td>
                    <td>
                        <?php echo form_input(array('name'=>'skill','value'=>get_data($_POST,'skill'),'class'=>'form-field'));?>
                    </td>
                </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo form_input(array('name'=>'telepon','value'=>get_data($_POST,'telepon'),'class'=>'form-field'));?>
                    </td>
                </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo form_input(array('name'=>'lastPayment','value'=>get_data($_POST,'lastPayment'),'class'=>'form-field'));?>
                    </td>
                </tr> 
                <tr>
                    <td width="200">Gaji Penawaran</td>
                    <td>
                        <?php echo form_input(array('name'=>'lastTarget','value'=>get_data($_POST,'lastTarget'),'class'=>'form-field'));?>
                    </td>
                </tr> 
                <tr>
