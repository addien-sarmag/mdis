		...
		<div class="clear"></div>
            ...
            <tbody>
                ...
                <tr class=<?php echo $class?>>
                    ...
                    <td>
                    	<?php echo isAccess('pegawai','pegawai','detail') ? anchor('pegawai/pegawai/detail/id/' . $row['nip_karyawan'],'<span class="icon_text pack _284"></span>Detail', 'class="button white"', 'class="button white"') : ''?>
                    
                        <?php echo isAccess('pegawai','pegawai','edit') ? anchor('pegawai/pegawai/edit/id/' . $row['nip_karyawan'],'<span class="icon_text edit"></span>Edit', 'class="button white"', 'class="button white"') : ''?>
                        
                        <?php echo isAccess('pegawai','pegawai','delete') ? anchor('pegawai/pegawai/view/page/'.$uri_to_assoc['page'].'/action/delete/id/' . $row['nip_karyawan'],'<span class="icon_text cancel"></span>Hapus', array('onClick' => "return confirm('".$this->lang->line('global_confirm_delete')."')" , 'class' => "button white")) : ''?>
                    </td>
                </tr> 
                <?php endforeach;?>
            </tbody>
