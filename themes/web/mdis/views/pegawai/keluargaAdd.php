...
<div class="column full">
		...
		<div class="box">
		<div class="box-header">Tambah Keluarga</div>
        ...
        <br /><br />      
            ...
            <?php  echo form_open('pegawai/keluarga/add/nip/'.get_data($uri_to_assoc,'nip').'/time/' . time(),array('name'=>'formAddkeluarga','id'=>'formAddkeluarga'),array('kirim'=>'kirim')); ?>
            <table> 
            	<tr>
                    <td width="200">Nip</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo form_input(array('name'=>'pekerjaan','value'=>get_data($_POST,'pekerjaan'),'class'=>'form-field'));?>
                    </td>
                </tr> 
                 <tr>
