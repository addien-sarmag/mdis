...
<div class="column full">
		...
		<div class="box">
		<div class="box-header">Tambah Pengobatan</div>
        ...
        <br /><br />      
            ...
            <?php  echo form_open('pegawai/pengobatan/add/time/' . time(),array('name'=>'formAddpengobatan','id'=>'formAddpengobatan'),array('kirim'=>'kirim')); ?>
            <table> 
                <tr>
